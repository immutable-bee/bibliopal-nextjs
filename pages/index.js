  ...
  return (
    <div className="flex flex-col items-center w-full mb-10 p-5">
      ...
      <div className="flex flex-col w-full items-center gap-5 border-t-2 border-gray py-10">
        ...
        <h6 className="pt-20 text-4xl">Start Your Free Account Today!</h6>
      ...
      <div className="flex flex-col gap-3 items-center w-full">
        <div className="flex justify-center gap-5 items-center w-full">
          ...
          <div>
            <h6 className="pb-5 text-4xl">Search Books</h6>
        ...
        <div className="flex justify-center gap-5 items-center w-full">
          <div>
            <h6 className="pb-5 text-4xl">Automated Notifications</h6>
            <h6 className="pt-5 max-w-lg ">
        ...
        <div className="flex justify-center gap-5 items-center w-full">
          ...
          <div>
            <h6 className="pb-5 text-4xl">Save Money</h6>
            <h6 className="pt-5 max-w-lg ">
      ...
      <div className="flex justify-center gap-10 items-center w-full mt-20">
        <div className="border-2 border-gray-100">
          <Image
        ...
        <div>
          <h6 className="pb-5 text-5xl">Got Books?</h6>
