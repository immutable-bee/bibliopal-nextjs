...
const ManageSubscriptionModal = (props) => {
  ...
  const planDetailsHandler = (value) => {
    ...
    if (value === "Not Subscribed") {
      details = {
        one: "- 5k listing limit",
        two: "- Buy and sell in state",
        three: "- Request books in state",
        four: "- Platform closing fee ($2 flat fee + 10% over $10)",
      };
    } else if (
      ...
      details = {
        one: "- List up to 1000 per month",
        two: "- 30 day inventory visibility",
      };
    } else if (
  ...
  const PlanDetails = ({ plan, details }) => (
    <>
      ...
      <ul id="plan-details" className="text-sm text-black !mt-2">
        Plan Features:
        <li className="text-xs !mt-1 text-gray-600 font-normal">{details.one}</li>
        <li className="text-xs text-gray-600 font-normal">{details.two}</li>
        <li className="text-xs text-gray-600 font-normal">{details.three}</li>
        <li className="text-xs text-gray-600 font-normal">{details.four}</li>
      </ul>
    </>
  );
...
//     switch (plan) {
//       case "Monthly Plan (State)":
//         setUpgradeRequest("Monthly Plan (State)");
//       case "Yearly Plan (State)":
//         setUpgradeRequest("Yearly Plan (State)");
//         break;
//       case "Monthly Plan (National)":
...
//       return (
//         <>
//           <h6 className="text-base font-semibold text-center">Amount: $5.99</h6>
//           <ButtonComponent
//             color="blue" full rounded
//             onClick={upgradePlanViewHandler}
//           >
...
//         <>
//           {subscriptionStatus === "Monthly Plan (National)" ? (
//             <h6 className="text-sm font-semibold">Amount: $11.99</h6>
//           ) : (
//             <h6 className="text-sm font-semibold">Amount: $49.99</h6>
//           )}
//           <ButtonComponent
//             onClick={upgradePlanViewHandler}
//           >
...
//       return (
//         <>
//           <h6 className="text-sm font-semibold">Amount: $99.99</h6>
//           <ButtonComponent
//             full rounded
//             onClick={downgradePlanViewHandler}
//           >
...
//             <ButtonComponent
//               color="blue" full rounded
//               onClick={() => confirmUpgradeViewHandler("Monthly Plan (State)")}
//             >
//               Monthly (State) $5.99
//             </ButtonComponent>
//             <ButtonComponent
...
//         );
//       }
//       else if (subscriptionStatus === "Monthly Plan (State)") {
//         return (
//           <>
//             {upgradeMessage()}
//             <ButtonComponent
//               color="blue" full rounded
//               onClick={() =>
//                 confirmUpgradeViewHandler("Monthly Plan (State)")
//               }
//             >
//               Monthly (State) $5.99
//             </ButtonComponent>
...
//           <>
//             <h6 className="text-sm font-semibold">
//               New Plan: Monthly (State) $5.99/Monthly
//             </h6>
//             <ul id="plan-details" className="text-sm text-black !mt-2">
//               Plan Features:
//               <li className="text-xs !mt-1 text-gray-600 font-normal">{planDetailsHandler(confirmUpgradeView).one}</li>
//               <li className="text-xs text-gray-600 font-normal">{planDetailsHandler(confirmUpgradeView).two}</li>
//               <li className="text-xs text-gray-600 font-normal">{planDetailsHandler(confirmUpgradeView).three}</li>
//               <li className="text-xs text-gray-600 font-normal">{planDetailsHandler(confirmUpgradeView).four}</li>
//             </ul>
//             <h6 className="text-sm font-semibold">
//               Due Today:{" "}
//               {amountDueLoading ? (
...
//           <>
//             <h6 className="text-sm font-semibold">
//               New Plan: Yearly (State) $49.99/Year
//             </h6>
...
//           <>
//             <h6 className="text-sm font-semibold">
//               New Plan: Monthly (National) $11.99/Monthly
//             </h6>
//             <ul id="plan-details" className="text-sm text-black !mt-2">
//               Plan Features:
//               <li className="text-xs !mt-1 text-gray-600 font-normal">{planDetailsHandler(confirmUpgradeView).one}</li>
...
//           <>
//             <h6 className="text-sm font-semibold">
//               New Plan: Yearly (National) $99.99/Year
//             </h6>
//             <ul id="plan-details" className="text-sm text-black !mt-2">
//               Plan Features:
//               <li className="text-xs !mt-1 text-gray-600 font-normal">{planDetailsHandler(confirmUpgradeView).one}</li>
...
//             <ul id="plan-details" className="text-sm text-black !mt-2">
//               Plan Features:
//               <li className="text-xs !mt-1 text-gray-600 font-normal">{planDetailsHandler(confirmDowngradeView).one}</li>
//               <li className="text-xs text-gray-600 font-normal">{planDetailsHandler(confirmDowngradeView).two}</li>
//               <li className="text-xs text-gray-600 font-normal">{planDetailsHandler(confirmDowngradeView).three}</li>
//               <li className="text-xs text-gray-600 font-normal">{planDetailsHandler(confirmDowngradeView).four}</li>
//             </ul>
//             <h6 className="text-sm font-semibold">Start Date: {billingDate}</h6>
//             {requestResponseLoading ? (
//               <LoadingComponent />
...
//           <>
//             <h6 className="text-sm font-semibold">
//               New Plan: Monthly (State) $5.99/Month
//             </h6>
//             <ul id="plan-details" className="text-sm text-black !mt-2">
//               Plan Features:
//               <li className="text-xs !mt-1 text-gray-600 font-normal">{planDetailsHandler(confirmDowngradeView).one}</li>
