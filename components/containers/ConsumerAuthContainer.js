          ...
          <div className="w-full">
            ...
            <div className="auth-content-container">
              ...
              <h2 className="pt-5 text-sm text-center">
                Get Started with a reader account by signing up below.
              </h2>
              ...
              <p className="text-center pt-2 text-sm">
                Did you mean to sign up for a seller account?<br></br>Click{" "}
                <Link
                  className="text-blbBlue text-md"
                  href={"/auth?type=business"}
                >
                  {" "}
                  Here{" "}
                </Link>
...
export default ConsumerAuthContainer;
